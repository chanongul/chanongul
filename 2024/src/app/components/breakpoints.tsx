export default function Breakpoints() {
  return (
    <div className="fixed bottom-0 left-0 m-2 flex items-center rounded-full bg-white p-2 text-sm text-orange-500">
      <span className="2xs:!hidden font-extrabold sm:!hidden md:!hidden lg:!hidden xl:!hidden xs:!hidden">
        3xs
      </span>
      <span className="2xs:!inline !hidden font-extrabold xs:!hidden">2xs</span>

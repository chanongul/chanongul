  ...
  return (
    ...
    >
      {logo ? (
        ...
        <div
          className={`relative rounded-xl border border-neutral-400 bg-neutral-100 bg-clip-padding px-[1em] py-[0.5em] font-sans font-medium leading-none transition-[background-color,border-color] duration-300 dark:border-neutral-500 dark:bg-neutral-800 ${!isNaN(+prof) ? "touch:group-active/group:border-transparent no-touch:group-hover/group:border-transparent" : ""}`}
        >
          <p>{name}</p>
          <div className="absolute bottom-full left-1/2 z-10 hidden w-max -translate-x-1/2 flex-col items-center justify-center rounded-lg bg-neutral-600/50 px-2 py-1 font-mono !text-white backdrop-blur-md touch:group-active/self:flex no-touch:group-hover/self:flex">
            <p className="text-[0.75em] leading-tight">

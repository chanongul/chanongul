...
export default function ProjectLinks({
  ...
  return (
    <article className="col-span-2 grid size-full grid-cols-[2fr_1fr] gap-2 sm:gap-3 xl:gap-4 landscape:col-span-1 landscape:gap-2 xl:landscape:gap-4">
      <Link
        href="/projects"
      ...
      >
        {isMounted && (
          <>
            ...
            <p className="hidden w-full flex-col text-center font-mono text-[0.75em] leading-tight md:text-[1em] md:leading-normal 2xl:!text-[1.25em] landscape:flex landscape:text-[0.6em] lg:landscape:text-[0.85em] xl:landscape:text-[1em]">
              Explore
              <span className="text-[3em] font-black leading-none text-orange-500 landscape:text-[3em] lg:landscape:text-[4em] xl:landscape:text-[5em]">

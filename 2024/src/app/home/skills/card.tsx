...
export default function SkillCard({ logo, name, prof }: SkillCardProps) {
  ...
  return (
    <div
      className={`mx-1 flex items-center justify-center md:mx-1.5 xl:mx-2 ${logo ? "size-8 min-w-8 rounded-[20%] sm:!size-12 sm:!min-w-12 md:!size-14 md:!min-w-14 2xs:size-10 2xs:min-w-10 landscape:!size-6 landscape:!min-w-6 md:landscape:!size-10 md:landscape:!min-w-10 lg:landscape:!size-14 lg:landscape:!min-w-14 xl:landscape:!size-20 xl:landscape:!min-w-20 2xl:landscape:!size-24 2xl:landscape:!min-w-24" : "w-max rounded-xl"}`}
      style={{
